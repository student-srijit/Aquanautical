...
export async function POST(req: NextRequest) {
  try {
    ...
    const hostEmail = process.env.HOST_EMAIL || 'srijitd248@gmail.com'
    ...
    if (isContactForm) {
      const { firstName, lastName, email, institution, message } = data
      textContent = `
NEW CONTACT FORM SUBMISSION - Aquanautical
...
---
This email was sent from the Aquanautical contact form.
Reply directly to this email to respond to ${firstName}.
      ...
      textContent = `
NEW DATA SUBMISSION - Aquanautical
...
---
This email was sent from the Aquanautical data submission system.
...
The file is attached to this email and can be downloaded.
    ...
    const mailOptions: any = {
      from: `"Aquanautical Platform" <${hostEmail}>`,
    ...
    console.log("Email sent successfully to srijitd248@gmail.com")
